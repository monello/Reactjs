...
export const auth = (email, password, isSignupMode) => {
    return dispatch => {
        ...
        let url = 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyD_63dsWi8By6O4QUTz0vSleTPLnCSpguQ';
        if (!isSignupMode) {
            url = 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyD_63dsWi8By6O4QUTz0vSleTPLnCSpguQ'
        }
