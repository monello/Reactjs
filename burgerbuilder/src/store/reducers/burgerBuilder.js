...
const addIngredient = (state, action) => {
    const addedIngredient = {[action.payload.ingredient]: state.ingredients[action.payload.ingredient] + 1};
...
const removeIngredient = (state, action) => {
    const removedIngredient = {[action.payload.ingredient]: state.ingredients[action.payload.ingredient] - 1};
