...
const mapDispatchToProps = dispatch => {
    return {
        onAddIngredient: (ingredient) => dispatch(actionTypes.addIngredient(ingredient)),
        onRemoveIngredient: (ingredient) => dispatch(actionTypes.removeIngredient(ingredient)),
